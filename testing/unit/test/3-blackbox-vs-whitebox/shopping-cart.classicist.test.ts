...
test('should remove item when quantity updated to zero or negative', () => {
  cart.addItem(products.mouse, 2);
...
test('should calculate total with discount and tax for regular customer', async () => {
  // Arrange
...
test('should apply VIP discount', async () => {
  // Arrange
  cart.addItem(products.laptop, 1); // $1200
...
test('should handle different tax locations', async () => {
  // Arrange
...
test('should send notification after checkout', async () => {
  // Arrange
...
test('should handle full shopping workflow', async () => {
