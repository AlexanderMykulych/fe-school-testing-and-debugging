...
describe('ShoppingCart - Mockist Style (Whitebox)', () => {
  ...
  describe('checkout', () => {
    ...
    it('should call tax service with discounted amount', async () => {
      // Arrange
    ...
    it('should call notification service after successful checkout', async () => {
      // Arrange  
      cart.addItem(sampleProduct, 1);
      const customerId = 'customer-123';
      const location = 'US';
    ...
    it('should not call services when cart is empty', async () => {
